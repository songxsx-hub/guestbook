  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                required rows={3} placeholder="写下你想说的话..."
        ...
        <Link
          href="/buy"
          className="block w-full text-center py-3 rounded-xl text-sm font-medium text-white mb-8 hover:opacity-90 transition-opacity"
